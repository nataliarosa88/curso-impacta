...
public class Cap19_Lab1 {
	...
	public void abreConexao(){
		try{
			...
			System.out.println("N�o foi poss�vel estabelecer conex�o " + e);
			System.exit(1);
		}
	}
	...
	public void fechaConexao(){
		try{
			...
			System.out.println("N�o foi poss�vel fechar conex�o " + e);
			System.exit(1);
		}
	}
	...
	public void imprimir(){		
		try{
			...
			while(rs.next()){
				...
				System.out.println("M�dia: "+(rs.getDouble("nota1")+rs.getDouble("nota2")+rs.getDouble("nota3"))/3);
			}
		}catch(SQLException e){
			e.printStackTrace();
		}
