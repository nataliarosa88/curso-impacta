...
public class ExemploStream {
    ...
    public static void main(String[] args) {
        ...
        list.add(new Funcionario(1780, "Jo�o Ricardo",    "Desenvolvedor", 7100.0));
        list.add(new Funcionario(5200, "Ana Maria",       "Vendedor",      4100.0));
        list.add(new Funcionario(3420, "Andr� de Souza",  "Desenvolvedor", 5890.0));
        list.add(new Funcionario(3999, "Robson Gusm�o",   "Analista",      6500.0));
